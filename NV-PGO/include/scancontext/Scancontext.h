...
public: 
    ...
    std::pair<Eigen::MatrixXd,pcl::PointCloud<pcl::PointXYZI>> makeScancontext_density( pcl::PointCloud<SCPointType> & _scan_down );
    std::pair<Eigen::MatrixXd,pcl::PointCloud<pcl::PointXYZI>> makeScancontext( pcl::PointCloud<SCPointType> & _scan_down );
    ...
    // User-side API
    pcl::PointCloud<pcl::PointXYZI> makeAndSaveScancontextAndKeys_density( pcl::PointCloud<SCPointType> & _scan_down );
    pcl::PointCloud<pcl::PointXYZI> makeAndSaveScancontextAndKeys( pcl::PointCloud<SCPointType> & _scan_down );
...
public:
    ...
    double Similar_SC_DIST_THRES = 0.6;

    double desc_THRES = 25;
    // config 
    ...
    void setSimilarCdistThres(double _new_thres);
    void setdesc_THRES(double _new_thres);
    ...
    bool similar_tree_built_ = false; // cache flag: skip rebuild when SleepMap data unchanged
