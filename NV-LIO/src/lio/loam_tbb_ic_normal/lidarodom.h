...
namespace zjloc::loam_tbbic_normal
{
     ...
     public:
          ...
          void setFunc(std::function<bool(std::string &topic_name, pcl::PointCloud<pcl::PointXYZINormal>::Ptr &cloud, double time)> &fun) override;
          ...
          void setFunc(std::function<bool(std::string &topic_name, std_msgs::Bool isbegin_seeeion, double time)> &fun) override;
     private:
          void loadOptions();
          /// 使用IMU初始化
          void TryInitIMU();
          ...
          void addPointToPcl(pcl::PointCloud<pcl::PointXYZINormal>::Ptr pcl_points_lidar, 
                                   pcl::PointCloud<pcl::PointXYZINormal>::Ptr pcl_points_world, 
                                   const point3D &pt, const double &intensity);
     ...
     private:
          ...
          std::function<bool(std::string &topic_name, pcl::PointCloud<pcl::PointXYZINormal>::Ptr &cloud, double time)> pub_normalcloud_to_ros;
          ...
          std::function<bool(std::string &topic_name, std_msgs::Bool isbegin_seeeion, double time)> pub_bool_to_ros;
          pcl::PointCloud<pcl::PointXYZINormal>::Ptr points_world;
          pcl::PointCloud<pcl::PointXYZINormal>::Ptr points_world_map;
          pcl::PointCloud<pcl::PointXYZINormal>::Ptr points_lidar;
