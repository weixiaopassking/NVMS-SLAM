...
namespace zjloc::loam_tbbic
{
     ...
     private:
          ...
          void addPointToMap(voxelHashMap2 &map, const Eigen::Vector3d &point,
          ...
          searchNeighbors(const voxelHashMap2 &map, const Eigen::Vector3d &point,
     ...
     private:
          ...
          std::list<std::pair<voxel, std::shared_ptr<voxelBlock>>> grids_cache_;
