...
namespace zjloc
{
    ...
    void Keyframe::Save(std::ostream &os)
    {
        ...
        os << id_ << " " << std::setprecision(18) << timestamp_ << " " << rtk_heading_valid_ << " " << rtk_valid_ << " "
           << rtk_inlier_ << " ";
        os << rtk_info_[0] << " " << rtk_info_[1] << " " << rtk_info_[2] << " " << rtk_info_[3] << " " << rtk_info_[4] << " " << rtk_info_[5] << " ";

        save_SE3(os, lidar_pose_); //  7
    ...
    void Keyframe::Load(std::istream &is)
    {
        ...
        is >> rtk_info_[0] >> rtk_info_[1] >> rtk_info_[2] >> rtk_info_[3] >> rtk_info_[4] >> rtk_info_[5];
